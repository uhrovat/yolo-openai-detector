...
> This file mirrors **AGENTS.md**, which is the canonical project constitution.
> It exists so a Claude Code session loads the same operational law. If you edit
> one file, edit the other to match. **When in doubt, AGENTS.md governs.**
